...
```
git remote add upstream https://github.com/bocks/bocks.git
```
...
Prefix each commit like so:
  ...
  - (refactor) Refactor the thing
  - (cleanup) Cleanup the code
  - (test) Add test that does this thing
  - (doc) Document the thing
...
- [Commit messages should be written in the present tense]((https://news.ycombinator.com/item?id=2079612)); e.g. "Fix continuous integration script".
